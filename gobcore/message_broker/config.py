...
MESSAGE_IMPORT_RESULT_KEY = _build_key(MESSAGE_IMPORT, JOBSTEP_RESULT)
...
MESSAGE_IMPORT_REQUEST_KEY = _build_key(MESSAGE_IMPORT, REQUEST)
...
MESSAGE_IMPORT_QUEUE = _build_queuename(WORKFLOW_EXCHANGE, MESSAGE_IMPORT)
...
QUEUE_CONFIGURATION = {
    WORKFLOW_EXCHANGE: {
        ...
        MESSAGE_IMPORT_QUEUE: [
            MESSAGE_IMPORT_REQUEST_KEY,
        ],
    },
    STATUS_EXCHANGE: {
        HEARTBEAT_QUEUE: [
