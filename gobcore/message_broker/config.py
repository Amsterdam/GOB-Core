...
EVENT_PRODUCE_RESULT_KEY = _build_key(EVENT_PRODUCE, JOBSTEP_RESULT)
...
EVENT_PRODUCE_REQUEST_KEY = _build_key(EVENT_PRODUCE, REQUEST)
...
EVENT_PRODUCE_QUEUE = _build_queuename(WORKFLOW_EXCHANGE, EVENT_PRODUCE)
